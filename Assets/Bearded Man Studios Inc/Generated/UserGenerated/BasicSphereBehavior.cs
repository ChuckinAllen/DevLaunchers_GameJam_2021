...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class BasicSphereBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (BasicSphereNetworkObject)obj;
		...
		{
			Initialize(new BasicSphereNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new BasicSphereNetworkObject(networker, this, createCode, metadata);
		}
